...
#define NIL_CFG_ST_FREQUENCY                3906 /* working well for Periodic Tick mode */
...
#define CH_CFG_ST_TIMEDELTA                0 //had to add this to eliminate warning in avr_timers.h line 22
